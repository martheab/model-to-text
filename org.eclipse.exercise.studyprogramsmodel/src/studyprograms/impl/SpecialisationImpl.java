 ...
 *   <li>{@link studyprograms.impl.SpecialisationImpl#getSpecializations <em>Specializations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecialisationImpl extends MinimalEObjectImpl.Container implements Specialisation {
	 ...
	 * @ordered
	 */
	protected EList<Specialisation> specializations;
	 ...
	 */
	@Override
	public EList<Specialisation> getSpecializations() {
		if (specializations == null) {
			specializations = new EObjectContainmentEList<Specialisation>(Specialisation.class, this, StudyprogramsPackage.SPECIALISATION__SPECIALIZATIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StudyprogramsPackage.SPECIALISATION__SPECIALIZATIONS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StudyprogramsPackage.SPECIALISATION__SPECIALIZATIONS:
				...
				getSpecializations().addAll((Collection<? extends Specialisation>)newValue);
				return;
		}
